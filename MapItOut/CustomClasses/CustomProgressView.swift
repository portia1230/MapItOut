...
public enum CircularProgressGlowMode {
    case forward, reverse, constant, noGlow
}

@IBDesignable
public class CustomCircularProgress: UIView, CAAnimationDelegate {
    ...
    @IBInspectable public var glowMode: CircularProgressGlowMode = .forward {
        didSet {
